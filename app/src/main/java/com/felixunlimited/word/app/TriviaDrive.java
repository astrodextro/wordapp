...
//
//import static com.felixunlimited.word.app.util.IabBroadcastReceiver.*;
//import static com.felixunlimited.word.app.util.IabHelper.*;
//
///**
...
// */
//public class TriviaDrive extends Activity implements IabBroadcastListener,
//        OnClickListener {
...
//                mBroadcastReceiver = new IabBroadcastReceiver(TriviaDrive.this);
//                IntentFilter broadcastFilter = new IntentFilter(ACTION);
...
//            try {
//                mHelper.launchPurchaseFlow(this, mSelectedSubscriptionPeriod, ITEM_TYPE_SUBS,
