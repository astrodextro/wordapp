 ...
 * in a {@link UserMessagesListActivity}.
 * <p/>
...
//        setupWindowAnimations();
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putParcelable(MessageDetailFragment.MESSAGE_DETAIL_URI, getIntent().getData());
...
//    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            //
            NavUtils.navigateUpTo(this, new Intent(this, UserMessagesListActivity.class));
            return true;
        }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_HEADSETHOOK:
                startService(new Intent(MessagePlayerService.ACTION_TOGGLE_PLAYBACK));
                return true;
        }
