...
package com.felixunlimited.word.app.util;
...
public class IabHelper {
    ...
    void logDebug(String msg) {
        if (mDebugLog) log(mDebugTag, msg, Utility.getUniquePsuedoID(), System.currentTimeMillis(), 'd', null, mContext);
    }

    void logError(String msg) {
        log(mDebugTag, "In-app billing error: " + msg, Utility.getUniquePsuedoID(), System.currentTimeMillis(), 'e', null, mContext);
    }

    void logWarn(String msg) {
        log(mDebugTag, "In-app billing warning: " + msg, Utility.getUniquePsuedoID(), System.currentTimeMillis(), 'w', null, mContext);
    }
}