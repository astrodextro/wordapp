...
/**
 * Manages "Authentication" to WordApp's backend service.  The SyncAdapter framework
 ...
 */
public class WordAppAuthenticator extends AbstractAccountAuthenticator {

    public WordAppAuthenticator(Context context) {
        super(context);
    }
